            ...
            $this->menu='<header class="p-3 text-bg-dark">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    ...
                    <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                        ...
                        <li><a href="crud/crudusuarios.php" class="nav-link px-2 text-white">CRUD usuarios</a></li>                    
        ...
        public function setMenuCRUD(){            
            $this->menuCRUD='<header class="p-3 text-bg-dark">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    ...
                    <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                        <li><a href="../index.php" class="nav-link px-2 text-secondary">Inicio</a></li>
                        <li><a href="crud.php" class="nav-link px-2 text-white">CRUD</a></li>
                        <li><a href="crudusuarios.php" class="nav-link px-2 text-white">CRUD usuarios</a></li>
                    </ul>
